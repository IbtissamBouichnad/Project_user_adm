		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App for users management",
									"targetURL": "#projectusersadm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectusersadm-display": {
								"semanticObject": "projectusersadm",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectusersadm",
									"url": sap.ui.require.toUrl("projectusersadm")
								}
							}
						}
					}
